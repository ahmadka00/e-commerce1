...
SECRET_KEY = 'django-insecure--4)pqp=^024v4k!xqpx-v9mbt5ck(ep92#qwa2vfavguq))vp3'
...
INSTALLED_APPS = [
    ...
    # added schema and documentation API 
    'drf_spectacular',
...
# AWS_STORAGE_BUCKET_NAME = "e-commerce1-static"
